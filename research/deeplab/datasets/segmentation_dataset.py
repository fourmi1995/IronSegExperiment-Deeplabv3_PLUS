...
# segmentation_dataset.py line 110 _CAMVID_INFORMATION = DatasetDescriptor( splits_to_sizes={ 'train': 367, # num of samples in images/training 'val': 101, # num o


_CAMVID_INFORMATION = DatasetDescriptor(
     splits_to_sizes={ 
         'train': 1550, # num of samples in images/training 
         'val': 400, # num of samples in images/validation
     },
     num_classes=4, 
     ignore_label=255,
 )
